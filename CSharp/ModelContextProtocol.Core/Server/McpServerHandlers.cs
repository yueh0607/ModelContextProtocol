...
namespace MapleModelContextProtocol.Server
{
    ...
    public sealed class McpServerHandlers
    {
        ...
        /// 它支持通过游标机制进行分页，客户端可以使用上一次调用返回的游标进行重复调用以检索更多工具。
        /// </para>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// 此处理程序与 <see cref="McpServerPrompt"/>（未实现） 集合中定义的任何提示一起工作。
        ...
        /// </summary>
        /// <remarks>
        /// 当客户端请求特定提示的详细信息，但该提示未在 <see cref="McpServerPrompt"/> （未实现）集合中找到时，将调用此处理程序。
